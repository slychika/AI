...
def main():
	...
	maxi = str(raw_input('Who is max(r or d): ')).upper()
	if maxi != ('R' or 'D'):
		print("error")
	...
	build_gametree((frozenset([]),),legalSet, gametree, 3, board)
	print gametree.__len__()
	print gametree.node(data=True)	
